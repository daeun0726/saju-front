    ...
    <div className="min-h-screen bg-[#f8f8f8]">
      <div className="max-w-107.5 mx-auto min-h-screen">
        ...
        <div className="px-4 pb-16 space-y-5">
          {/* 사주팔자 */}
          <section id="saju">
            <p className="text-[16px] font-bold text-[#222] pt-5 mb-2.5">사주해석</p>
            <div className="space-y-2.5">
              <Manseryuk pillars={profile.pillars} />

              {/* 일간 */}
              <div className="bg-white rounded-2xl px-4.5 py-4 space-y-[11px]">
                <p className="text-[14px] font-bold text-[#aaa]">일간</p>
                <div className="bg-[#f9f9f9] rounded-xl flex items-center gap-3 px-[14px] pt-[15px] pb-3">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[14px] font-bold text-[#222]">{profile.dayMaster.name}</p>
                    <p className="text-[12px] font-semibold text-[#aaa]">{profile.dayMaster.subtitle}</p>
                  </div>
                </div>
                <p className="text-[14px] text-[#444] leading-[22px]">
              ...
              <div className="bg-white rounded-2xl px-4.5 py-4 space-y-2">
                <p className="text-[14px] font-bold text-[#aaa]">기본 성격</p>
                {[
                  ...
                  <div
                    key={item.label}
                    className="bg-[#f9f9f9] rounded-xl px-[14px] py-3 space-y-1"
                  >
                    <p className="text-[12px] font-bold text-[#e24f63]">{item.label}</p>
                    <p className="text-[16px] font-bold text-[#222]">{item.title}</p>
                    <p className="text-[14px] text-[#444] leading-[21.45px] pt-px">{item.description}</p>
                  </div>
                ))}
              </div>
            </div>
